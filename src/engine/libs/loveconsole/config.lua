...
config.fontName = "game/data/fonts/meslolgl.ttf" -- Filename of the font to be used. Leave it blank to use the default font.
config.fontSize = 14 -- Size of the console font.
...
config.ignoreToggleKey = true -- If true, the toggle key will not be inputted to the console's input field.
