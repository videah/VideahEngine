...
--[[---------------------------------------------------------
	- func: SetColumnAlign(id, align)
	- desc: sets the align of the specified column
--]]---------------------------------------------------------
function newobject:SetColumnAlign(id, align)
...
--[[---------------------------------------------------------
	- func: GetColumnAlign(id)
	- desc: gets the align of the specified column
--]]---------------------------------------------------------
function newobject:GetColumnAlign(id)
