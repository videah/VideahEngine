...
-- hue2rgb, rgb2hsl and hsl2rgb were stolen from:
...
function Color:alpha(alpha)
  local h, s, l = unpack(self.hsl)

  return rgb({self[1], self[2], self[3], alpha}, {h, s, l, a})
end
  --return rgb({self[1], self[2], self[3], self[4])
